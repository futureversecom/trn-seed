...
// 		log::info!(target: "Migration", "Nft: Running migration with current storage version {current:?}
// / onchain {onchain:?}");
//
...
// 		} else {
// 			log::info!(target: "Migration", "Nft: No migration was done. If you are seeing this message, it
// means that you forgot to remove old existing migration code. Don't panic, it's not a big deal
...
// 	}
//
// 	impl<AccountId, MaxTokensPerCollection> OldCollectionInformation<AccountId,
// MaxTokensPerCollection> 	where
// 		AccountId: Debug + PartialEq + Clone,
// 		MaxTokensPerCollection: Get<u32>,
// 	{
// 		pub fn transform(
