...
pub mod v1 {
    ...
    use pallet_nfi::{
        ...
        types::{NFISubType, NFIDataType, NFIMatrix, MultiChainTokenId, GenericCollectionId, GenericSerialNumber},
    };
    ...
    pub fn migrate<T: frame_system::Config + pallet_nfi::Config + pallet_evm_chain_id::Config>() -> Weight {
    ...
    mod tests {
        ...
        fn migrate_with_data() {
            new_test_ext().execute_with(|| {
                ...
                Map::unsafe_storage_put::<NFIDataType<<Runtime as pallet_nfi::Config>::MaxDataLength>>(
                    b"Nfi",
                    b"NfiData",
                    &key_1,
                    data.clone(),
                ...
                // Verify NfiEnabled
                let collection_id = GenericCollectionId::U32(collection_id);
                let migrated_enabled = NewNfiEnabled::<Runtime>::get((chain_id, collection_id), sub_type);
                assert_eq!(migrated_enabled, true);

                let collection_id_2 = GenericCollectionId::U32(collection_id_2);
                let migrated_enabled_2 = NewNfiEnabled::<Runtime>::get((chain_id, collection_id_2), sub_type);
