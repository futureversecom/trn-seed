...
impl<T: frame_system::Config> pallet_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply() -> Weight {
		Weight::from_ref_time(211_392_000 as u64)
	...
	fn swap_with_exact_target() -> Weight {
		Weight::from_ref_time(212_604_000 as u64)
			.saturating_add(T::DbWeight::get().reads(8 as u64))
			.saturating_add(T::DbWeight::get().writes(7 as u64))
	}
	...
	fn add_liquidity() -> Weight {
		Weight::from_ref_time(414_378_000 as u64)
	...
	fn remove_liquidity() -> Weight {
		Weight::from_ref_time(337_912_000 as u64)
	...
	fn disable_trading_pair() -> Weight {
		Weight::from_ref_time(69_684_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Dex FeeTo (r:0 w:1)
	fn set_fee_to() -> Weight {
		Weight::from_ref_time(41_947_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
