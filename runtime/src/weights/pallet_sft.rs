...
impl<T: frame_system::Config> pallet_sft::WeightInfo for WeightInfo<T> {
	...
	fn create_collection() -> Weight {
		Weight::from_ref_time(27_587_000 as u64)
	...
	fn create_token() -> Weight {
		Weight::from_ref_time(18_388_000 as u64)
	...
	fn mint() -> Weight {
		Weight::from_ref_time(18_461_000 as u64)
	...
	// Storage: Sft TokenInfo (r:1 w:1)
	fn burn() -> Weight {
		Weight::from_ref_time(17_772_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Sft SftCollectionInfo (r:1 w:1)
	fn set_owner() -> Weight {
		Weight::from_ref_time(15_898_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Sft SftCollectionInfo (r:1 w:0)
	...
	fn set_max_issuance() -> Weight {
		Weight::from_ref_time(16_396_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Sft SftCollectionInfo (r:1 w:1)
	fn set_base_uri() -> Weight {
		Weight::from_ref_time(14_430_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
