...
impl<T: frame_system::Config> pallet_sft::WeightInfo for WeightInfo<T> {
	...
	fn mint() -> Weight {
		...
		Weight::from_parts(22_392_000, 0)
	...
	fn transfer(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_121_685, 0)
			.saturating_add(Weight::from_parts(0, 3480))
			// Standard Error: 10_050
			.saturating_add(Weight::from_parts(5_285_495, 0).saturating_mul(p.into()))
	...
	fn issue_soulbound(p: u32, ) -> Weight {
		...
		Weight::from_parts(21_300_000, 0)
			...
			.saturating_add(Weight::from_parts(5_992_709, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(3))
