...
impl<T: frame_system::Config> pallet_sylo_action_permissions::WeightInfo for WeightInfo<T> {
	...
	fn grant_transact_permission(c: u32, ) -> Weight {
		...
		Weight::from_parts(16_355_633, 0)
			.saturating_add(Weight::from_parts(0, 1007566))
			// Standard Error: 1_127
			.saturating_add(Weight::from_parts(967_692, 0).saturating_mul(c.into()))
	...
	fn update_transact_permission(c: u32, ) -> Weight {
		...
		Weight::from_parts(18_364_392, 0)
			.saturating_add(Weight::from_parts(0, 1007566))
			// Standard Error: 1_027
			.saturating_add(Weight::from_parts(691_895, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `SyloActionPermissions::TransactPermissions` (r:1 w:1)
