...
impl<T: frame_system::Config> pallet_partner_attribution::WeightInfo for WeightInfo<T> {
	...
	fn register_partner_account() -> Weight {
		...
		//  Measured:  `76`
		//  Estimated: `1501`
		// Minimum execution time: 41_305_000 picoseconds.
		Weight::from_parts(41_924_000, 0)
	...
	fn update_partner_account() -> Weight {
		...
		Weight::from_parts(42_572_000, 0)
	...
	fn attribute_account() -> Weight {
		...
		Weight::from_parts(45_067_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn upgrade_partner() -> Weight {
		...
		Weight::from_parts(40_287_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn create_futurepass_with_partner() -> Weight {
		...
		Weight::from_parts(227_029_000, 0)
	...
	fn remove_partner() -> Weight {
		...
		Weight::from_parts(46_318_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: `PartnerAttribution::AdminAccount` (r:1 w:1)
	/// Proof: `PartnerAttribution::AdminAccount` (`max_values`: Some(1), `max_size`: Some(20), added: 515, mode: `MaxEncodedLen`)
	fn set_admin() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `76`
		//  Estimated: `1505`
		// Minimum execution time: 30_236_000 picoseconds.
