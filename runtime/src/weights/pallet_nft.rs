...
impl<T: frame_system::Config> pallet_nft::WeightInfo for WeightInfo<T> {
	...
	fn burn() -> Weight {
		...
		//  Measured:  `377`
		//  Estimated: `4631`
		// Minimum execution time: 78_614_000 picoseconds.
	...
	fn set_token_transferable_flag() -> Weight {
		...
		//  Measured:  `331`
		//  Estimated: `3484`
		// Minimum execution time: 55_378_000 picoseconds.
	...
	fn accept_soulbound_issuance() -> Weight {
		...
		//  Measured:  `447`
		//  Estimated: `3994`
		// Minimum execution time: 88_964_000 picoseconds.
		Weight::from_parts(90_696_000, 0)
			.saturating_add(Weight::from_parts(0, 3994))
			.saturating_add(T::DbWeight::get().reads(6))
