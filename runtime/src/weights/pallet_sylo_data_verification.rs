...
impl<T: frame_system::Config> pallet_sylo_data_verification::WeightInfo for WeightInfo<T> {
	...
	fn register_resolver(p: u32, ) -> Weight {
		...
		Weight::from_parts(13_142_111, 0)
			.saturating_add(Weight::from_parts(0, 9016))
			// Standard Error: 6_190
			.saturating_add(Weight::from_parts(963_722, 0).saturating_mul(p.into()))
	...
	fn update_resolver(p: u32, ) -> Weight {
		...
		Weight::from_parts(14_432_133, 0)
			.saturating_add(Weight::from_parts(0, 9016))
			// Standard Error: 9_394
			.saturating_add(Weight::from_parts(914_316, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `SyloDataVerification::Resolvers` (r:1 w:1)
	...
	fn create_validation_record(q: u32, r: u32, ) -> Weight {
		...
		Weight::from_parts(17_601_616, 0)
			.saturating_add(Weight::from_parts(0, 23189))
			// Standard Error: 14_106
			.saturating_add(Weight::from_parts(1_029_092, 0).saturating_mul(q.into()))
			// Standard Error: 14_106
			.saturating_add(Weight::from_parts(451_118, 0).saturating_mul(r.into()))
	...
	fn update_validation_record(q: u32, r: u32, ) -> Weight {
		...
		Weight::from_parts(15_460_281, 0)
			.saturating_add(Weight::from_parts(0, 23189))
			// Standard Error: 17_807
			.saturating_add(Weight::from_parts(3_620_361, 0).saturating_mul(q.into()))
			// Standard Error: 17_807
			.saturating_add(Weight::from_parts(1_036_724, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `SyloDataVerification::ValidationRecords` (r:1 w:1)
