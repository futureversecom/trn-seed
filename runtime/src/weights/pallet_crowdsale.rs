...
impl<T: frame_system::Config> pallet_crowdsale::WeightInfo for WeightInfo<T> {
	...
	fn initialize() -> Weight {
		Weight::from_all(242_201_000 as u64)
	...
	fn enable() -> Weight {
		Weight::from_all(69_876_000 as u64)
	...
	fn participate() -> Weight {
		Weight::from_all(157_983_000 as u64)
	...
	fn distribute_crowdsale_rewards() -> Weight {
		Weight::from_all(244_465_000 as u64)
	...
	fn claim_voucher() -> Weight {
		Weight::from_all(238_375_000 as u64)
			.saturating_add(T::DbWeight::get().reads(10 as u64))
	...
	fn redeem_voucher() -> Weight {
		Weight::from_all(176_790_000 as u64)
	...
	fn try_force_distribution() -> Weight {
		Weight::from_all(66_053_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Crowdsale SaleEndBlocks (r:1 w:1)
	...
	fn on_initialize(p: u32, ) -> Weight {
		Weight::from_all(212_761_000 as u64)
			// Standard Error: 953_527
			.saturating_add(Weight::from_all(97_043_987 as u64).saturating_mul(p as u64))
	...
	fn on_initialize_empty() -> Weight {
		Weight::from_all(9_826_000 as u64)
