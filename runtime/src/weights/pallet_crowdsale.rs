...
impl<T: frame_system::Config> pallet_crowdsale::WeightInfo for WeightInfo<T> {
	...
	fn initialize() -> Weight {
		Weight::from_ref_time(248_593_000 as u64)
	...
	fn participate() -> Weight {
		Weight::from_ref_time(161_250_000 as u64)
	...
	fn distribute_crowdsale_rewards() -> Weight {
		Weight::from_ref_time(248_318_000 as u64)
	...
	fn claim_voucher() -> Weight {
		Weight::from_ref_time(241_268_000 as u64)
			.saturating_add(T::DbWeight::get().reads(10 as u64))
	...
	fn redeem_voucher() -> Weight {
		Weight::from_ref_time(178_332_000 as u64)
	...
	fn on_initialize(p: u32, ) -> Weight {
		Weight::from_ref_time(217_162_000 as u64)
			// Standard Error: 1_012_171
			.saturating_add(Weight::from_ref_time(102_301_369 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(12 as u64))
