...
impl<T: frame_system::Config> pallet_xrpl_bridge::WeightInfo for WeightInfo<T> {
	...
	fn reset_settled_xrpl_tx_data(i: u32, ) -> Weight {
		...
		Weight::from_parts(12_831_319, 0)
			.saturating_add(Weight::from_parts(0, 1887623333))
			// Standard Error: 8_431
			.saturating_add(Weight::from_parts(5_468_998, 0).saturating_mul(i.into()))
	...
	fn prune_settled_ledger_index(i: u32, ) -> Weight {
		...
		//  Estimated: `64003481`
		// Minimum execution time: 14_000_000 picoseconds.
		Weight::from_parts(14_897_367, 0)
			.saturating_add(Weight::from_parts(0, 64003481))
			// Standard Error: 6_403
			.saturating_add(Weight::from_parts(1_236_423, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
