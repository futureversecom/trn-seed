...
impl<T: frame_system::Config> pallet_sylo_data_permissions::WeightInfo for WeightInfo<T> {
	...
	fn grant_data_permissions(p: u32, ) -> Weight {
		...
		Weight::from_parts(67_952_000, 0)
			.saturating_add(Weight::from_parts(0, 23189))
			// Standard Error: 155_567
			.saturating_add(Weight::from_parts(29_722_027, 0).saturating_mul(p.into()))
	...
	fn grant_tagged_permissions(p: u32, ) -> Weight {
		...
		Weight::from_parts(54_825_668, 0)
			.saturating_add(Weight::from_parts(0, 507123))
			// Standard Error: 7_641
			.saturating_add(Weight::from_parts(34_437, 0).saturating_mul(p.into()))
	...
	fn revoke_permission_reference() -> Weight {
		...
		Weight::from_parts(43_182_000, 0)
