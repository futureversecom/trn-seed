...
impl<T: frame_system::Config> pallet_sylo::WeightInfo for WeightInfo<T> {
	...
	fn register_resolver(p: u32, q: u32, ) -> Weight {
		...
		Weight::from_parts(9_810_772, 0)
			.saturating_add(Weight::from_parts(0, 9016))
			// Standard Error: 396
			.saturating_add(Weight::from_parts(16_181, 0).saturating_mul(p.into()))
			// Standard Error: 10_331
			.saturating_add(Weight::from_parts(580_835, 0).saturating_mul(q.into()))
	...
	fn update_resolver(p: u32, q: u32, ) -> Weight {
		...
		Weight::from_parts(14_432_618, 0)
			.saturating_add(Weight::from_parts(0, 9016))
			// Standard Error: 612
			.saturating_add(Weight::from_parts(4_979, 0).saturating_mul(p.into()))
			// Standard Error: 15_971
			.saturating_add(Weight::from_parts(547_485, 0).saturating_mul(q.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Sylo::Resolvers` (r:1 w:1)
	...
	fn create_validation_record(p: u32, q: u32, r: u32, ) -> Weight {
		...
		Weight::from_parts(16_031_373, 0)
			.saturating_add(Weight::from_parts(0, 23189))
			// Standard Error: 395
			.saturating_add(Weight::from_parts(8_002, 0).saturating_mul(p.into()))
			// Standard Error: 10_281
			.saturating_add(Weight::from_parts(535_434, 0).saturating_mul(q.into()))
			// Standard Error: 10_281
			.saturating_add(Weight::from_parts(221_085, 0).saturating_mul(r.into()))
	...
	fn update_validation_record(p: u32, q: u32, ) -> Weight {
		...
		Weight::from_parts(16_231_580, 0)
			.saturating_add(Weight::from_parts(0, 23189))
			// Standard Error: 9_032
			.saturating_add(Weight::from_parts(1_648_218, 0).saturating_mul(p.into()))
			// Standard Error: 9_032
			.saturating_add(Weight::from_parts(415_619, 0).saturating_mul(q.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Sylo::ValidationRecords` (r:1 w:1)
