...
interface Marketplace {
    ...
    function sellNftWithoutMarketplaceId(address collectionAddress, uint256[] calldata serialNumberIds, address buyer, address paymentAsset, uint256 fixedPrice, uint256 duration) external returns (uint listingId)";
    ...
    function sellSftWithoutMarketplaceId(address collectionAddress, uint256[] calldata serialNumberIds, uint256[] calldata quantities, address buyer, address paymentAsset, uint256 fixedPrice, uint256 duration) external returns (uint listingId)";
    ...
    function auctionNftWithoutMarketplaceId(address collectionAddress, uint256[] calldata serialNumberIds, address paymentAsset, uint256 reservePrice, uint256 duration) external payable;
    function auctionSftWithMarketplaceId(address collectionAddress, uint256[] calldata serialNumberIds, uint256[] calldata quantities, address paymentAsset, uint256 reservePrice, uint256 duration, uint256 marketplaceId) external payable;
    function auctionSftWithoutMarketplaceId(address collectionAddress, uint256[] calldata serialNumberIds, uint256[] calldata quantities, address paymentAsset, uint256 reservePrice, uint256 duration) external payable;
