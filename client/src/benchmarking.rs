...
impl frame_benchmarking_cli::ExtrinsicBuilder for RemarkBuilder {
	...
	fn build(&self, nonce: u32) -> std::result::Result<OpaqueExtrinsic, &'static str> {
		let acc: sp_core::ecdsa::Pair =
			sp_core::ecdsa::Pair::from_string("//Bob", None).unwrap();
...
impl frame_benchmarking_cli::ExtrinsicBuilder for TransferKeepAliveBuilder {
	...
	fn build(&self, nonce: u32) -> std::result::Result<OpaqueExtrinsic, &'static str> {
		let acc = sp_core::ecdsa::Pair::from_string("//Bob", None).unwrap();
		let extrinsic: OpaqueExtrinsic = create_benchmark_extrinsic(
			self.client.as_ref(),
			acc,
...
pub fn create_benchmark_extrinsic(
	...
	let extra: runtime::SignedExtra = (
		...
		pallet_maintenance_mode::MaintenanceChecker::<runtime::Runtime>::new(),
	...
	runtime::UncheckedExtrinsic::new_signed(
		call.clone(),
		EthereumSigner::from(sender.public()).into_account(),
