...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn initialize() -> Weight {
		Weight::from_all(104_000_000 as u64)
	...
	fn participate() -> Weight {
		Weight::from_all(67_000_000 as u64)
	...
	fn distribute_crowdsale_rewards() -> Weight {
		Weight::from_all(98_000_000 as u64)
	...
	// Proof: `Crowdsale::SaleDistribution` (`max_values`: Some(1), `max_size`: Some(16002), added: 16497, mode: `MaxEncodedLen`)
	fn claim_voucher() -> Weight {
		Weight::from_all(96_000_000 as u64)
			.saturating_add(T::DbWeight::get().reads(10 as u64))
	...
	fn on_initialize(p: u32, ) -> Weight {
		Weight::from_all(4_149_591 as u64)
			// Standard Error: 470_855
			.saturating_add(Weight::from_all(94_511_273 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
