...
// --output
// ./pallet/incentive/src/weights.rs
// --template
...
/// Weight functions needed for pallet_incentive.
...
/// Weights for pallet_incentive using the Substrate node and recommended hardware.
