...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_collection(p: u32, ) -> Weight {
		Weight::from_all(103_415_723)
			// Standard Error: 5_493
			.saturating_add(Weight::from_all(3_853_867_u64).saturating_mul(p as u64))
	...
	/// The range of component `p` is `[1, 500]`.
	fn mint(p: u32, ) -> Weight {
		Weight::from_all(192_632_016)
			// Standard Error: 6_419
			.saturating_add(Weight::from_all(3_818_810_u64).saturating_mul(p as u64))
	...
	/// The range of component `p` is `[1, 500]`.
	fn transfer(p: u32, ) -> Weight {
		Weight::from_all(88_178_000)
			// Standard Error: 17_634
			.saturating_add(Weight::from_all(12_096_955_u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(p as u64)))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(p as u64)))
	}
	// Storage: `Migration::Status` (r:1 w:0)
	// Proof: `Migration::Status` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	// Storage: `Nft::UtilityFlags` (r:1 w:0)
