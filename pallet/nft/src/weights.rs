...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_collection(p: u32, ) -> Weight {
		Weight::from_all(28_222_179)
			// Standard Error: 121
			.saturating_add(Weight::from_all(1_473_u64).saturating_mul(p as u64))
	...
	/// The range of component `p` is `[1, 500]`.
	fn mint(p: u32, ) -> Weight {
		Weight::from_all(64_796_311)
			// Standard Error: 301
			.saturating_add(Weight::from_all(1_827_u64).saturating_mul(p as u64))
	...
	/// The range of component `p` is `[1, 500]`.
	fn transfer(p: u32, ) -> Weight {
		Weight::from_all(18_806_000)
			// Standard Error: 4_367
			.saturating_add(Weight::from_all(3_754_938_u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2))
