...
// --pallet=pallet_event_proof
// --extrinsic=*
// --steps=50
// --repeat=20
// --heap-pages=4096
// --template=./.maintain/frame-weight-template.hbs
// --output=./pallets/event_proof/src/weights.rs
...
/// Weight functions needed for pallet_event_proof
pub trait WeightInfo {
	fn set_delayed_event_proofs_per_block() -> Weight;
}

/// Weights for pallet_event_proof using the Substrate node and recommended hardware.
