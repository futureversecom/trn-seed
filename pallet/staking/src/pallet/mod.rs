...
use frame_support::{
	...
	traits::{
		...
		EstimateNextNewSession, Get, Imbalance, LockIdentifier, LockableCurrency, OnUnbalanced,
		UnixTime,
	},
	weights::Weight,
};
...
pub mod pallet {
	...
	pub trait Config: frame_system::Config + SendTransactionTypes<Call<Self>> {
		...
		/// For the longer payout period which encompasses eras
	...
	pub enum Event<T: Config> {
		...
		// New payouts variants:
		/// Errors from within on_initialize
	...
	pub enum Error<T> {
		...
		// Below are variants for the new staking payouts, intentionally left separate
	...
	// New staking payouts pallet storage items zone:
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn accumulate_payouts(
			...
			let history_depth = Pallet::<T>::history_depth();
