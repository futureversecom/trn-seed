...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(22_513_007)
			// Standard Error: 2_197
			.saturating_add(Weight::from_all(55_151_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(23_185_468)
			// Standard Error: 1_639
			.saturating_add(Weight::from_all(49_222_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(18_740_266)
			// Standard Error: 18_584
			.saturating_add(Weight::from_all(1_951_258_u64).saturating_mul(b as u64))
	...
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(19_000_000)
			...
			.saturating_add(Weight::from_all(4_344_082_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(66_280_143)
			// Standard Error: 159_409
			.saturating_add(Weight::from_all(9_159_410_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(8_503_018)
			// Standard Error: 308
			.saturating_add(Weight::from_all(875_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `VortexDistribution::EnableManualRewardInput` (r:1 w:0)
	// Proof: `VortexDistribution::EnableManualRewardInput` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	fn register_rewards(b: u32, ) -> Weight {
		Weight::from_all(20_000_000)
			// Standard Error: 39_127
			.saturating_add(Weight::from_all(5_163_368_u64).saturating_mul(b as u64))
