...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(34_509_768)
			// Standard Error: 2_389
			.saturating_add(Weight::from_all(80_971_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(35_173_685)
			// Standard Error: 1_242
			.saturating_add(Weight::from_all(69_603_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(52_330_000)
			// Standard Error: 72_909
			.saturating_add(Weight::from_all(13_131_793_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(38_587_910)
			// Standard Error: 4_558
			.saturating_add(Weight::from_all(8_134_094_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(37_472_232)
			// Standard Error: 7_212
			.saturating_add(Weight::from_all(8_073_600_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(b as u64)))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(b as u64)))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(25_931_674)
			// Standard Error: 113
			.saturating_add(Weight::from_all(10_827_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `VortexDistribution::EnableManualRewardInput` (r:1 w:0)
	// Proof: `VortexDistribution::EnableManualRewardInput` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_rewards(b: u32, ) -> Weight {
		Weight::from_all(43_211_924)
			// Standard Error: 11_577
			.saturating_add(Weight::from_all(8_200_112_u64).saturating_mul(b as u64))
