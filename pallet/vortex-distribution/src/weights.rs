...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(8_943_177)
			// Standard Error: 968
			.saturating_add(Weight::from_all(28_137_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(6_773_037)
			// Standard Error: 926
			.saturating_add(Weight::from_all(39_176_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(16_000_000)
			...
			.saturating_add(Weight::from_all(5_253_223_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(17_000_000)
			...
			.saturating_add(Weight::from_all(3_936_586_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(5_163_630)
			// Standard Error: 5_327
			.saturating_add(Weight::from_all(3_946_861_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(b as u64)))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(b as u64)))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(7_119_759)
			// Standard Error: 97
			.saturating_add(Weight::from_all(2_352_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
