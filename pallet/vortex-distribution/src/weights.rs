...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(14_964_784)
			// Standard Error: 1_482
			.saturating_add(Weight::from_all(52_784_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(15_364_609)
			// Standard Error: 1_711
			.saturating_add(Weight::from_all(41_834_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(16_000_000)
			// Standard Error: 25_147
			.saturating_add(Weight::from_all(5_206_399_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(5_776_206)
			// Standard Error: 2_877
			.saturating_add(Weight::from_all(3_949_691_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(4_012_753)
			// Standard Error: 3_427
			.saturating_add(Weight::from_all(3_939_313_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(b as u64)))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(b as u64)))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(7_065_583)
			// Standard Error: 108
			.saturating_add(Weight::from_all(2_609_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `VortexDistribution::EnableManualRewardInput` (r:1 w:0)
	// Proof: `VortexDistribution::EnableManualRewardInput` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_rewards(b: u32, ) -> Weight {
		Weight::from_all(5_218_200)
			// Standard Error: 3_075
			.saturating_add(Weight::from_all(2_499_687_u64).saturating_mul(b as u64))
