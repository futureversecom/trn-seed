...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(16_191_770)
			// Standard Error: 1_777
			.saturating_add(Weight::from_all(36_046_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(8_765_735)
			// Standard Error: 1_702
			.saturating_add(Weight::from_all(62_604_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(3_806_475)
			// Standard Error: 7_521
			.saturating_add(Weight::from_all(1_785_759_u64).saturating_mul(b as u64))
	...
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(16_000_000)
			...
			.saturating_add(Weight::from_all(4_049_900_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(16_919_591)
			// Standard Error: 37_491
			.saturating_add(Weight::from_all(7_756_549_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn trigger_vtx_distribution(b: u32, p: u32, ) -> Weight {
		Weight::from_all(1_137_154_870)
			// Standard Error: 225_604
			.saturating_add(Weight::from_all(49_005_384_u64).saturating_mul(b as u64))
			// Standard Error: 566_949
			.saturating_add(Weight::from_all(6_828_071_u64).saturating_mul(p as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(7_141_118)
			// Standard Error: 121
			.saturating_add(Weight::from_all(3_195_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `VortexDistribution::EnableManualRewardInput` (r:1 w:0)
	// Proof: `VortexDistribution::EnableManualRewardInput` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	fn register_rewards(b: u32, ) -> Weight {
		Weight::from_all(19_000_000)
			...
			.saturating_add(Weight::from_all(3_950_529_u64).saturating_mul(b as u64))
