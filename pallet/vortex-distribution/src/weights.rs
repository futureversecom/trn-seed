...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_fee_pot_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(34_520_030)
			// Standard Error: 814
			.saturating_add(Weight::from_all(57_437_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_asset_balances(b: u32, ) -> Weight {
		Weight::from_all(35_746_013)
			// Standard Error: 869
			.saturating_add(Weight::from_all(53_233_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_asset_prices(b: u32, ) -> Weight {
		Weight::from_all(15_669_976)
			// Standard Error: 6_806
			.saturating_add(Weight::from_all(3_664_439_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_reward_points(b: u32, ) -> Weight {
		Weight::from_all(34_375_375)
			// Standard Error: 5_176
			.saturating_add(Weight::from_all(8_124_285_u64).saturating_mul(b as u64))
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_work_points(b: u32, ) -> Weight {
		Weight::from_all(28_847_221)
			// Standard Error: 11_333
			.saturating_add(Weight::from_all(8_163_581_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(b as u64)))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(b as u64)))
	...
	/// The range of component `b` is `[1, 500]`.
	fn set_vtx_vault_redeem_asset_list(b: u32, ) -> Weight {
		Weight::from_all(26_382_949)
			// Standard Error: 105
			.saturating_add(Weight::from_all(10_665_u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `VortexDistribution::EnableManualRewardInput` (r:1 w:0)
	// Proof: `VortexDistribution::EnableManualRewardInput` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	/// The range of component `b` is `[1, 500]`.
	fn register_rewards(b: u32, ) -> Weight {
		Weight::from_all(45_376_493)
			// Standard Error: 6_015
			.saturating_add(Weight::from_all(8_200_420_u64).saturating_mul(b as u64))
