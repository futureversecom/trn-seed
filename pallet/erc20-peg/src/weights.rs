...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn activate_withdrawals() -> Weight {
		Weight::from_ref_time(3_900_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn withdraw() -> Weight {
		Weight::from_ref_time(50_597_000 as u64)
			.saturating_add(T::DbWeight::get().reads(11 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: Erc20Peg ContractAddress (r:0 w:1)
	fn set_contract_address() -> Weight {
		Weight::from_ref_time(10_399_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn set_payment_delay() -> Weight {
		Weight::from_ref_time(10_583_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
