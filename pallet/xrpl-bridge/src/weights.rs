...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	// Proof: `XRPLBridge::TicketSequenceThresholdReachedEmitted` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	fn withdraw_asset() -> Weight {
		Weight::from_all(147_000_000 as u64)
	...
	fn reset_settled_xrpl_tx_data(i: u32, ) -> Weight {
		Weight::from_all(40_379_586 as u64)
			// Standard Error: 52_758
			.saturating_add(Weight::from_all(5_500_473 as u64).saturating_mul(i as u64))
	...
	fn prune_settled_ledger_index(i: u32, ) -> Weight {
		Weight::from_all(16_804_970 as u64)
			// Standard Error: 9_136
			.saturating_add(Weight::from_all(1_380_316 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
