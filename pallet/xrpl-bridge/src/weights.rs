...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn submit_transaction() -> Weight {
		Weight::from_all(24_000_000 as u64)
	...
	fn withdraw_xrp() -> Weight {
		Weight::from_all(73_000_000 as u64)
	...
	// Proof: `XRPLBridge::TicketSequenceThresholdReachedEmitted` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	fn set_ticket_sequence_current_allocation() -> Weight {
		Weight::from_all(13_000_000 as u64)
	...
	fn reset_settled_xrpl_tx_data(i: u32, ) -> Weight {
		Weight::from_all(1_887_510 as u64)
			// Standard Error: 7_277
			.saturating_add(Weight::from_all(5_411_609 as u64).saturating_mul(i as u64))
	...
	fn prune_settled_ledger_index(i: u32, ) -> Weight {
		Weight::from_all(15_177_949 as u64)
			// Standard Error: 7_466
			.saturating_add(Weight::from_all(1_205_320 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
