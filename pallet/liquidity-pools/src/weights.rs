...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn trigger_pool_update() -> Weight {
		Weight::from_all(57_308_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// The range of component `n` is `[1, 10]`.
	fn process_closing_pools(n: u32, ) -> Weight {
		Weight::from_all(2_002_961)
			// Standard Error: 2_022
			.saturating_add(Weight::from_all(45_863_u64).saturating_mul(n as u64))
	}
