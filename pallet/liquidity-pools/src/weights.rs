...
impl WeightInfo for () {
	...
	fn process_closing_pools() -> Weight {
		Weight::from_all(2_821_703_000)
			.saturating_add(RocksDbWeight::get().reads(95))
