...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn grant_data_permissions(p: u32, ) -> Weight {
		Weight::from_all(67_732_000)
			// Standard Error: 42_303
			.saturating_add(Weight::from_all(29_176_273_u64).saturating_mul(p as u64))
	...
	/// The range of component `p` is `[1, 100]`.
	fn grant_tagged_permissions(p: u32, ) -> Weight {
		Weight::from_all(54_715_930)
			// Standard Error: 2_391
			.saturating_add(Weight::from_all(32_496_u64).saturating_mul(p as u64))
